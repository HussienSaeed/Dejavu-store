      ...
      <Container class1="store-wrapper home-wrapper-2 py-5">
        <div className="row">
          <div className="col-3">
            ...
            <div className='filter-card mb-3'>
              <h3 className="filter-title shadow-lg">Filter By</h3>
              <div>
            ...
            <div className='filter-card mb-3'>
              ...
              <div className="product-tags d-flex flex-wrap align-items-center gap-10">
                ...
                <span className="badge bg-light text-secondary rounded-3 py-2 px-3">Mobiles</span>
            ...
            <div className='filter-card mb-3'>
              ...
              <div>
                <div className="random-products d-flex">
                  <div className="w-50"><img src="images/watch.jpg" className='img-fluid' alt="watch" /></div>
                  <div className="w-50">
          ...
          <div className="col-9">
            <div className="filter-sort-grid mb-3">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className='d-flex align-items-center gap-10'>
                  <p className="total-products mb-0">2 Products</p>
